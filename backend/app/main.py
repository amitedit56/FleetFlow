...
from app.routers import auth, vehicles, drivers, shipments, trips, users, company, maintenance, driver_assignment, driver_attendance, maintenance_alerts, analytics, fuel, dashboard
